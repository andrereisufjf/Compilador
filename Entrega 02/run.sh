...
java -jar ../antlr-4.8-complete.jar lang.g4 -visitor
...
javac -cp ".;antlr-4.8-complete.jar" lang/ast/*.java lang/parser/*.java lang/visitors/*.java lang/LangCompiler.java -d .
